# Aprendizado por Projeto Integrado (API) - Aldo Pereira Solutions
...
|  Team Member  | Yuri Ribeiro                 |   [![Linkedin Badge](https://img.shields.io/badge/Linkedin-blue?style=flat-square&logo=Linkedin&logoColor=white)](https://www.linkedin.com/in/beatriz-ribeiro-dos-santos) [![GitHub Badge](https://img.shields.io/badge/GitHub-111217?style=flat-square&logo=github&logoColor=white)](https://github.com/yuhhttps)   |
...
|----|------------|------------|--------|
| 1  | Alta  | Como cliente, quero acessar um dashboard no PowerBI contendo os dados de importação e exportação para obter uma visão maior e mais rápida do panorama comercial de São Paulo sem precisar manipular bases brutas. | 1 |
| 2  | Alta  | Como cliente, quero que o script Python no Google Colab cruze os dados brutos do ComexStat com a tabela de códigos de municípios do IBGE para garantir que os nomes das cidades de São Paulo estejam normalizados e sem erros de grafia para o Power BI. | 1 |
...
| 3  | Alta  | Como cliente, quero visualizar a evolução histórica das importações de SJC por categoria de produto, para monitorar a dependência de insumos externos e o crescimento industrial local. | 2 |
| 7  | Média | Como cliente, quero identificar os modais de transporte predominantes no estado de SP para priorizar investimentos em infraestrutura e manutenção dessas vias. | 2 |
...
| 4  | Alta  | Como cliente, quero comparar o saldo comercial entre diferentes municípios no período de 2021 a fevereiro de 2026 para identificar quais regiões apresentam maior resiliência econômica. | 3 |
...
| 8  | Média | Como cliente, quero filtrar as importações do vale do Paraíba por categoria de produto (NCM) e país de origem, para identificar insumos que hoje compramos de longe, mas que poderiam ser produzidos ou fornecidos localmente. | 3 |
...
| 03                | 08/06/2026 | concluído  | [MVP](MVP/sp3.md)  |
